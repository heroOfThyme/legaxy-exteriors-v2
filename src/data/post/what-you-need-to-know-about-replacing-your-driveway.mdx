...
<div class="relative left-1/2 right-1/2 -mx-[50vw] w-screen">
  <BeforeAfter
    title="Driveway Replacement Results"
    subtitle="See the incredible transformation from old, cracked concrete to a brand new, properly graded driveway."
...
{/* This one stays within the blog width for detail shots */}

<BeforeAfter
  title="Close-up Details"
  beforeImage={{
    src: "~/assets/images/driveway-detail-before.jpg",
    alt: "Close-up of cracks and damage",
    label: "Problem Areas"
  }}
  afterImage={{
    src: "~/assets/images/driveway-detail-after.jpg",
    alt: "Close-up of new concrete finish",
